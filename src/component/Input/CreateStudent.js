    ...
    <div>
      ...
      <div className="row bg-dark">
        ...
        <div className="col-md-6 d-flex align-items-center flex-column justify-content-center mt-md-0 mt-5 mb-md-0 mb-5">
          ...
          <input type="text" className="input" style={{ }} placeholder="Enter Student Name" name="name" onChange={handleChange} />
          {' '}
          <br />
          <input type="text" className="input" placeholder="Enter Student email" name="email" onChange={handleChange} />
          <br />
          <input type="text" className="input" placeholder="Enter Student Phone Number" name="phone" onChange={handleChange} />
          {' '}
          <br />
          <div style={{ width: '80%' }}>
            <Multiselect

...
const UpdateStudent = () => {
  ...
  const { updatedId } = useContext(MainContext);
  ...
  const [upUser] = useMutation(UPDATE_USER);
    ...
    <div className="row">
      ...
      <div className="col-md-10 bg-dark align-items-center">
        <div className="">
          ...
          <input type="text" value={users?.name} className="updated-input" placeholder="Enter Student Name" name="name" onChange={handleChange} />
          {' '}
          <br />
          <input type="text" className="updated-input" placeholder="Enter Student email" name="email" onChange={handleChange} />
          <br />
          <input type="text" className="updated-input" placeholder="Enter Student Phone Number" name="phone" onChange={handleChange} />
          {' '}
          <br />
          <div style={{ width: '40%' }}>
            <Multiselect
          ...
          <button className="submit-button" type="submit" onClick={updateUser}>Update Now</button>
          {
